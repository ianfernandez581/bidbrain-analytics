# deploy_dash_caltex.ps1 - redeploy ONLY the caltex dashboard SERVICE after editing
...
# The Caltex logo is an inline SVG wordmark in dashboard.html + main.py's login page (no PNG asset),
