...
<body>
  <form class="card" method="POST" action="/login">
    <div class="logo-wrap">
      <svg width="190" height="44" viewBox="0 0 190 44" role="img" aria-label="Caltex">
        <path transform="translate(3 4) scale(1.5)" d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14l-5-4.87 6.91-1.01L12 2z" fill="#E4002B"/>
        <text x="58" y="32" font-family="'Montserrat','Inter',sans-serif" font-size="27" font-weight="800" letter-spacing="1" fill="#EEF4F5">CALTEX</text>
      </svg>
    </div>
