# clients/client_STT/ — ST Telemedia GDC (APAC) · **LIVE**
...
```
 ...
 ───────────────────────              ─────────────────────             ──────────────────
 snowflake_data_pull fills             clients/client_STT/sql/*.sql filter        stt-dash (Cloud Run service)
...
gcloud builds submit clients/client_STT/job --tag $IMG --region australia-southeast1
...
gcloud builds submit clients/client_STT/dash --tag $IMG --region australia-southeast1
...
- [`../snowflake_data_pull/`](../../ingest/snowflake_data_pull/README.md) — where all four STT raw layers (GA4, LinkedIn, DV360, Google Ads) come from.
