...
WITH base AS (
  ...
  -- rejection rate, so drop any lead sent from a Transmission email DOMAIN. EXACT list, never
  -- LIKE '%transmission%' (fixed 2026-08-27 - the substring also matched allisontransmission.com
  -- and dhoottransmission.com, both real companies; see sql/10 for the full reasoning) -- the SAME
