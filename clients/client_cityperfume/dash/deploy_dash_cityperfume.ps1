# deploy_dash_cityperfume.ps1 - redeploy ONLY the cityperfume dashboard SERVICE after editing
...
# For data-shape changes use ..\job\deploy_job_cityperfume.ps1; for SQL view changes use
# ..\sql\deploy_views_cityperfume.ps1. For first-time standup use the one-shot ..\deploy_cityperfume.ps1.
#
...
# ---- config (matches deploy_cityperfume.ps1 + dash/cloudbuild.yaml) ---------
