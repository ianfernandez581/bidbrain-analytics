# clients/client_cityperfume/sql/ — the BigQuery views (stage-2 transform)
...
Apply:  `python clients/client_cityperfume/create_views.py`  (or `./deploy_views_cityperfume.ps1`, which
