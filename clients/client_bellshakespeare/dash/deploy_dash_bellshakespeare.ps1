# deploy_dash_bellshakespeare.ps1 - redeploy ONLY the bellshakespeare dashboard SERVICE after editing
...
# The Bell Shakespeare logo is an inline SVG wordmark in dashboard.html + main.py's login page (no PNG asset),
