<#
  scheduler.ps1  (Bell Shakespeare)
  Creates/refreshes a Cloud Scheduler trigger that runs the 'bellshakespeare-export'
  ...
  Run from anywhere:  .\client_bellshakespeare\scheduler.ps1
#>
...
$Sa       = "bellshakespeare-dash-job@bidbrain-analytics.iam.gserviceaccount.com"
$TimeZone = "UTC"
$Sched    = "$Job-daily"
