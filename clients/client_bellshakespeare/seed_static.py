r"""
client_bellshakespeare/seed_static.py -- load the VERSION-CONTROLLED target CSVs in targets/ into
BigQuery `client_bellshakespeare.seed_*` tables.

Bell Shakespeare's targets are a flat key/value model (flight_budget_aud, cpl_target_aud, ctr_target,
...
Run:  .\.venv\Scripts\python.exe clients\client_bellshakespeare\seed_static.py
"""
import os
