# enable_report_schneidersecpwr.ps1 - ONE-TIME standup for the portal "Download slides" feature (dash/report.py).
# Grants the schneidersecpwr-dash runtime SA secret-read on the shared anthropic-api-key (+ optional gemini-api-key)
# and bucket-write (for the report cache), mounts the keys on the schneidersecpwr-dash service, and bumps the Cloud
...
#       .\clients\client_schneidersecpwr\dash\enable_report_schneidersecpwr.ps1
#   If you get "running scripts is disabled on this system":
#       Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass -Force
#
# After this runs once, redeploy the dashboard image normally with deploy_dash_schneidersecpwr.ps1 - the secret
...
$SA       = "schneidersecpwr-dash-web@bidbrain-analytics.iam.gserviceaccount.com"   # dash runtime SA
$SECRET   = "anthropic-api-key"
$GSECRET  = "gemini-api-key"
$BUCKET   = "bidbrain-analytics-schneidersecpwr-dash"   # private data bucket - report cache lives in reports/
...
Write-Host "Redeploy the dashboard image with deploy_dash_schneidersecpwr.ps1 to ship report.py + bb_deck.js + the new dashboard.html."
