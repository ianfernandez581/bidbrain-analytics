...
CONFIG = {
    ...
    "business_model": (
        ...
        "market on this brief, not a parsing artefact - and those same ad sets carry the line item \n"
        "'Unspecified' because their names carry no funnel-stage token. Do NOT describe either as \n"
        "missing, unmapped or broken data.\n"
