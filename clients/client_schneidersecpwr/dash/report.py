...
CONFIG = {
    ...
    "business_model": (
        ...
        "   3. SOFTWARE FIRST ECOSTRUXURE (brief 2305) — Australia and New Zealand, plus ONE \n"
        "combined-ANZ line. Its A/B-test ad sets were never split by country, so 'ANZ' is a REAL \n"
        "market on this brief, not a parsing artefact. Those same ad sets ARE the brief's LinkedIn \n"
        "CONVERSION line item - a landing-page A/B test (Expert page vs Interactive Demo Page), a \n"
        "website-conversion buy with NO lead form. LinkedIn's on-site conversion count is not in this \n"
        "feed, so that line is judged on reach, clicks and cost only: NEVER state or imply a \n"
        "conversion count for it, and do NOT describe the ANZ market as missing, unmapped or broken.\n"
    ...
    "guardrails": (
        ...
        "its multi-region footprint (India / MEA / South America / Pacific) distinct from the two Australasian \n"
        "briefs.\n"
