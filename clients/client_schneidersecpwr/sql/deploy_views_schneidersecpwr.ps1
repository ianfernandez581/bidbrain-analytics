...
#
# There is NO seed step here (unlike client_schneiderlqai / client_schneider): these three campaigns
# are DELIVERY-ONLY - no media plan, no targets, so no seed_* table. If a signed media plan ever
# lands, add data/media_plan.csv + load_seeds.py the repo-standard way and call it BEFORE
# create_views.py here.
#
