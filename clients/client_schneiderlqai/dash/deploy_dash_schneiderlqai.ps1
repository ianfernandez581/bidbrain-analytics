# deploy_dash_schneiderlqai.ps1 - redeploy ONLY the schneiderlqai dashboard SERVICE after editing
...
# For data-shape changes use deploy_job_schneiderlqai.ps1; for SQL view changes use
# deploy_views_schneiderlqai.ps1.
# For first-time standup (APIs, SAs, IAM, secrets, scheduler) use the one-shot deploy_schneiderlqai.ps1.
#
#   HOW TO RUN (from anywhere - paths resolve from the script's own folder):
#       .\client_schneiderlqai\dash\deploy_dash_schneiderlqai.ps1
#   If you get "running scripts is disabled on this system":
#       Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass -Force

# ---- config (matches deploy_schneiderlqai.ps1 + dash/cloudbuild.yaml) -----------
