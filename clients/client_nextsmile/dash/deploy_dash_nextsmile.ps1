# deploy_dash_nextsmile.ps1 - redeploy ONLY the nextsmile dashboard SERVICE after editing
...
# The Next Smile Australia logo is an inline SVG wordmark in dashboard.html + main.py's login page (no PNG asset),
# so there is no logo-copy step here. placeholder.json ships from this folder (baked in the image).
