...
Next Smile Australia — Next Smile Australia Meta paid-media campaign. Turns this client's LIVE numbers into a
...
def _fmt_brief(s):
    ...
    L.append("")
    L.append(f"Next Smile Australia campaign report — {s.get('generated_for','Next Smile Australia — Next Smile Australia')}. Currency: {cur}.")
    ...
    L.append("")
    L.append("## CAMPAIGN")
    L.append(f"Client: {s.get('client','nextsmile')}  |  Development: {ctx.get('campaign','Next Smile Australia')}  |  Currency: {cur}")
