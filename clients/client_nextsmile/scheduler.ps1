<#
  scheduler.ps1  (Next Smile Australia)
  Creates/refreshes a Cloud Scheduler trigger that runs the 'nextsmile-export'
  ...
  Run from anywhere:  .\client_nextsmile\scheduler.ps1
#>
...
$Sa       = "nextsmile-dash-job@bidbrain-analytics.iam.gserviceaccount.com"
$TimeZone = "UTC"
$Sched    = "$Job-daily"
