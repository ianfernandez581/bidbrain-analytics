<#
  scheduler.ps1  (Sophiie)
  Creates/refreshes a Cloud Scheduler trigger that runs the 'sophiie-export'
  ...
  Run from anywhere:  .\client_sophiie\scheduler.ps1
#>
...
$Job      = "sophiie-export"
$Sa       = "sophiie-dash-job@bidbrain-analytics.iam.gserviceaccount.com"
$TimeZone = "UTC"
$Sched    = "$Job-daily"
