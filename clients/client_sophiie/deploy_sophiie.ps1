# deploy_sophiie.ps1 - one-shot, idempotent stand-up of the client_sophiie PREVIEW dashboard.
#
# PREVIEW ONLY. Sophiie AI's campaigns are still being BUILT, so this client has NO data pipeline:
...
#
# This mirrors the Geyer Valmont / Bell Shakespeare / Next Smile Australia preview clients. There is
# deliberately no -WithData switch, because there is nothing to switch on yet - see
...
Write-Host "Deploying client_sophiie PREVIEW to $PROJECT ($REGION)`n"
...
Write-Host "`n============================================================"
Write-Host "  DONE. Sophiie AI PREVIEW dashboard is live (password-gated):"
Write-Host "    $URL"
...
Write-Host "  To go live later: see FLIPPING PREVIEW -> LIVE in clients\client_sophiie\README.md"
Write-Host "============================================================"
