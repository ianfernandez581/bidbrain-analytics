...
The normal way in is the **platform front-door — https://dashboards.bidbrain.ai/d/hireright/** (one
...
password-gated for direct access. There is **no** `hireright.bidbrain.ai` subdomain — the front-door is
