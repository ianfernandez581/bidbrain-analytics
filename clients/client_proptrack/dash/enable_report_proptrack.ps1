# enable_report_proptrack.ps1 - ONE-TIME standup for the portal "Download slides" feature (dash/report.py).
# Grants the proptrack-dash runtime SA secret-read on the shared anthropic-api-key (+ optional gemini-api-key)
# and bucket-write (for the report cache), mounts the keys on the proptrack-dash service, and bumps the Cloud
...
#       .\clients\client_proptrack\dash\enable_report_proptrack.ps1
#   If you get "running scripts is disabled on this system":
#       Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass -Force
#
# After this runs once, redeploy the dashboard image normally with deploy_dash_proptrack.ps1 - the secret
...
$SA       = "proptrack-dash-web@bidbrain-analytics.iam.gserviceaccount.com"   # dash runtime SA
$SECRET   = "anthropic-api-key"
$GSECRET  = "gemini-api-key"
$BUCKET   = "bidbrain-analytics-proptrack-dash"   # private data bucket - report cache lives in reports/
...
Write-Host "Redeploy the dashboard image with deploy_dash_proptrack.ps1 to ship report.py + bb_deck.js + the new dashboard.html."
