...
--   * an unmatched campaign is DROPPED by the JOIN in 20_pm_delivery / 22_search_campaigns, and
...
SELECT
  ...
  c.spend_aud,
  c.cost_usd,
  -- Must stay identical to the IN-list in 20_pm_delivery / 22_search_campaigns.
