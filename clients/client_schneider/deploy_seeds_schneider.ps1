...
#
# If you ALSO edited a sql/*.sql view, run sql/deploy_views_schneider.ps1 instead (it loads the seeds
# AND reapplies the views before re-running the job). For first-time standup use deploy_schneider.ps1.
#
#   HOW TO RUN (from anywhere - paths resolve from the script's own folder):
#       .\client_schneider\deploy_seeds_schneider.ps1
