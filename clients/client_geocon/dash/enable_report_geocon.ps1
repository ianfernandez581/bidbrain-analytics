# enable_report_geocon.ps1 - ONE-TIME standup for the "Download report" feature (dash/report.py).
...
# geocon-dash service, and bumps the Cloud Run request timeout so the two-stage Claude/Gemini call
...
#       .\clients\client_geocon\dash\enable_report_geocon.ps1 -Key "sk-ant-..." -GeminiKey "AQ...."
#   If you get "running scripts is disabled on this system":
#       Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass -Force
#
# After this runs once, redeploy the dashboard image normally with deploy_dash_geocon.ps1 - the
...
$SERVICE  = "geocon-dash"
$SA_FALLBACK = "geocon-dash-web@bidbrain-analytics.iam.gserviceaccount.com"   # dash runtime SA (convention)
$SECRET   = "anthropic-api-key"
$GSECRET  = "gemini-api-key"
$BUCKET   = "bidbrain-analytics-geocon-dash"   # private data bucket - report cache lives in reports/
...
else { Write-Host "geocon-dash runtime SA: $SA" }
