<#
  scheduler.ps1  (Geocon)
  Creates/refreshes a Cloud Scheduler trigger that runs the 'geocon-export'
  ...
  Run from anywhere:  .\client_geocon\scheduler.ps1
#>
...
$Job      = "geocon-export"
$Sa       = "geocon-dash-job@bidbrain-analytics.iam.gserviceaccount.com"
$TimeZone = "UTC"
$Sched    = "$Job-daily"
