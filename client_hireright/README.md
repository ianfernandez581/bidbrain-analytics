...
```
 ...
 ───────────────────────              ─────────────────────               ──────────────────
 snowflake_data_pull fills             client_hireright/sql/*.sql filter    hireright-dash (Cloud Run service)
...
gcloud builds submit client_hireright/job --tag $IMG --region australia-southeast1
...
gcloud builds submit client_hireright/dash --tag $IMG --region australia-southeast1
...
- [`../snowflake_data_pull/`](../snowflake_data_pull/README.md) — where the three HireRight raw layers come from.
