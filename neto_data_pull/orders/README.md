# neto_data_pull/orders/ — Neto / Maropost loader (`raw_neto.orders`)
...
> sibling of [`windsor_data_pull/`](../../windsor_data_pull/README.md) (`raw_windsor`) and
> [`snowflake_data_pull/`](../../snowflake_data_pull/README.md) (`raw_snowflake`): same
...
reporting layer (e.g. `client_cityperfume/sql/`), exactly like the other clients read `raw_windsor` /
...
/ units-sold / basket-size). Move these into `client_cityperfume/sql/` when wiring a dashboard.
