# ingest/dts_data_pull/ — native Google → BigQuery via Data Transfer Service

> The **third ingest unit**, sibling of [`ingest/windsor_data_pull/`](../windsor_data_pull/README.md)
> (Windsor → `raw_windsor`) and [`ingest/snowflake_data_pull/`](../snowflake_data_pull/README.md)
...
## See also
- [`ingest/windsor_data_pull/`](../windsor_data_pull/README.md) — the connector-based ingest this
