# ingest/snowflake_data_pull/ — mirror Snowflake into BigQuery (`raw_snowflake`)
...
> [`ingest/windsor_data_pull/`](../windsor_data_pull) (which fills `raw_windsor`).
...
- **Schneider** filters `tradedesk_apac_all`, `linkedin_ads_apac`, `dv360_apac`, and
  `google_analytics_apac_all` (see [`clients/client_schneider/sql/`](../../clients/client_schneider/sql/README.md)).
...
- [`ingest/windsor_data_pull/`](../windsor_data_pull/README.md) — the other shared ingest unit (`raw_windsor`).
