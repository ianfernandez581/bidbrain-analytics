"""Schneider Electric (APAC) dashboard web app (Cloud Run service).
...
<title>Schneider Electric · APAC Dashboard</title>
<style>
...
<body>
  <form class="card" method="POST" action="/login">
    ...
    <div class="brand">TRANSMISSION · SCHNEIDER ELECTRIC APAC</div>
