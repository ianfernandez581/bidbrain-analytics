# scheduler.ps1 - (re)create the */10 self-gating Cloud Scheduler trigger for the PropTrack export job.
#
...
#
#   .\client_proptrack\scheduler.ps1                 # */10 UTC (default) -- self-gating, rebuilds only on new data
