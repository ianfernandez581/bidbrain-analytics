# windsor_data_pull/tradedesk/ — The Trade Desk loader (`raw_windsor.perf_the_trade_desk`)

> Loads The Trade Desk (programmatic display/video) performance from Windsor.ai into BigQuery.
> Part of [`windsor_data_pull/`](../README.md) — read that first for the shared loader design
