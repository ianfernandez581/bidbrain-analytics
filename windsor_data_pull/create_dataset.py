...
perf_meta, perf_ga4, perf_ga4_events, perf_google_ads, perf_reddit) and that the
per-loader create_*_table.py scripts add tables into, so it must exist FIRST.
