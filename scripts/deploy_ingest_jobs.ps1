...
$JOBS = @(
  ...
  @{ key="tradedesk"; dir="ingest/windsor_data_pull/tradedesk"; job="windsor-tradedesk-ingest"; mem="1Gi"; cpu="1"; cron="35 1,21 * * *" },  # 2nd run 01:35 UTC = 11:35 AEST: pulls Sydney-yesterday same (Sydney) day, halving the dashboard lag
